...
"x86_64-linux-3.2.0-60-generic" or
	die "Errno architecture (x86_64-linux-3.2.0-60-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
