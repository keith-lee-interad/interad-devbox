...
tie %Config, 'Config', {
    archlibexp => '/opt/perl524/lib/5.24.4/x86_64-linux',
    ...
    osname => 'linux',
    osvers => '3.2.0-60-generic',
    path_sep => ':',
    privlibexp => '/opt/perl524/lib/5.24.4',
    scriptdir => '/opt/perl524/bin',
    sitearchexp => '/opt/perl524/lib/site_perl/5.24.4/x86_64-linux',
    sitelibexp => '/opt/perl524/lib/site_perl/5.24.4',
    so => 'so',
    useithreads => undef,
